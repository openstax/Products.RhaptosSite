...
setup(name='Products.RhaptosSite',
      ...
      install_requires=[
          ...
          'Products.AdvancedQuery==2.2-rhaptosdev-r30356',
          'Products.Five==1.4.4-rhaptosdev-r30356',
          'Products.LocalFS==1.7-rhaptosdev-r30356',
          'Products.ManagableIndex==1.7.3-rhaptosdev-r30356',
          'Products.MasterSelectWidget==0.2.3-rhaptosdev-r30356',
          'Products.NoHeaderFieldContinuation==0.1-rhaptosdev-r30356',
          'Products.OFolder==1.0-rhaptosdev-r30356',
          'Products.Ploneboard==1.1-rhaptosdev-r30356',
          'Products.References==0.10-rhaptosdev-r30356',
          'Products.SimpleAttachment==3.0.1-rhaptosdev-r30356',
          'Products.ZPsycopgDA==1.11-rhaptosdev-r30356',
